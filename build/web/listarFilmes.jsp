<%-- 
    Document   : listarFilmes
    Created on : 25/09/2016, 17:43:54
        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="logo">
                    ...
                    <a href="VitoriaVideos.jsp"><h2 style="font-family:'Lobster'" class="hidden-xs hidden-sm">VitoriaVideos</h2></a>
                ...
                <div class="navi">
                    ...
                    <ul style="list-style-type: none;">
                        ...
                        <li><a href="LocadoraController?action=listaUsuario"><i aria-hidden="true"></i><span class="hidden-xs hidden-sm">Usuarios do sistema</span></a></li>
            ...
            <body>
                <c:forEach items="${filme}" var="filme">
                    <tr>
                        ...
                        <td><c:out value="${filme.valor}"/></td>
                        <td><c:out value="${filme.genero}"/></td>
                        <td><a href="FilmeController?action=editar&id_filme=<c:out value="${filme.id_filme}"/>">Atualizar</a></td>
                        <td><a href="FilmeController?action=apagar&id_filme=<c:out value="${filme.id_filme}"/>">Apagar</a></td>
                    </tr>
                </c:forEach>
            </body>            
        </table>    
